...
class LSTMCRF(nn.Module):
    ...
    def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim, start_tag, stop_tag):
        ...
        self.transitions = nn.Parameter(
            torch.randn(self.tag_set_size, self.tag_set_size))
        ...
        for feat in feats:
            ...
            for next_tag in range(self.tag_set_size):
                ...
                emit_score = feat[next_tag].view(
                    1, -1).expand(1, self.tag_set_size)
    ...
    def _viterbi_decode(self, feats):
        ...
        for feat in feats:
            bptrs_t = []  # holds the back_pointers for this step
    ...
    def forward(self, sentence):
        # do not confuse this with _forward_alg above.
